...
export declare const Routes: {
     ...
     */
    guildAutoModerationRules(guildId: Snowflake): string;
    /**
     * Routes for:
     ...
     */
    guildAutoModerationRule(guildId: Snowflake, ruleId: Snowflake): string;
    /**
     * Route for:
...
export declare const CDNRoutes: {
     ...
     * This route supports the extensions: PNG, JPEG, WebP
     */
    applicationAsset(applicationId: Snowflake, applicationAssetId: string, format: ApplicationAssetFormat): `/app-icons/${string}/${string}.jpeg` | `/app-icons/${string}/${string}.png` | `/app-icons/${string}/${string}.webp`;
    /**
     * Route for:
     ...
     */
    sticker(stickerId: Snowflake, format: StickerFormat): `/stickers/${string}.png` | `/stickers/${string}.json`;
    /**
     * Route for:
...
export declare type DefaultUserAvatarAssets = 0 | 1 | 2 | 3 | 4 | 5;
export declare type EmojiFormat = Exclude<ImageFormat, ImageFormat.Lottie>;
export declare type GuildIconFormat = Exclude<ImageFormat, ImageFormat.Lottie>;
export declare type GuildSplashFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type GuildDiscoverySplashFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type GuildBannerFormat = Exclude<ImageFormat, ImageFormat.Lottie>;
export declare type UserBannerFormat = Exclude<ImageFormat, ImageFormat.Lottie>;
export declare type DefaultUserAvatar = Extract<ImageFormat, ImageFormat.PNG>;
export declare type UserAvatarFormat = Exclude<ImageFormat, ImageFormat.Lottie>;
export declare type GuildMemberAvatarFormat = Exclude<ImageFormat, ImageFormat.Lottie>;
export declare type ApplicationIconFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type ApplicationCoverFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type ApplicationAssetFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type AchievementIconFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type StickerPackBannerFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type TeamIconFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type StickerFormat = Extract<ImageFormat, ImageFormat.PNG | ImageFormat.Lottie>;
export declare type RoleIconFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type GuildScheduledEventCoverFormat = Exclude<ImageFormat, ImageFormat.Lottie | ImageFormat.GIF>;
export declare type GuildMemberBannerFormat = Exclude<ImageFormat, ImageFormat.Lottie>;
